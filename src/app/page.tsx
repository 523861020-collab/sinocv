    ...
    <>
      ...
      <section style={{paddingTop: '1.5rem', paddingBottom: '1.5rem'}} className="bg-black">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-400 italic text-base mb-10">
          ...
          <div className="flex flex-wrap justify-center gap-6">
            <a href="/images/cert-hk-1.jpg" target="_blank" className="rounded-xl overflow-hidden border border-gray-800 hover:border-amber-500/40 block w-full max-w-sm">
            ...
            <a href="/images/cert-hk-2.jpg" target="_blank" className="rounded-xl overflow-hidden border border-gray-800 hover:border-amber-500/40 block w-full max-w-sm">
