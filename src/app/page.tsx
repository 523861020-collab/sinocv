          ...
          <div className="max-w-6xl mx-auto mb-10 grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-900 via-gray-900 to-amber-950/20 border border-gray-800">
              ...
              <div className="relative flex flex-col items-center text-center p-8">
                <div className="relative mb-4">
                  ...
                  <img src="/images/manager.jpg" alt="李善龙" className="relative w-32 h-32 rounded-full object-cover border-4 border-amber-500/40 shadow-2xl shadow-amber-500/10" />
                </div>
                <h4 className="text-white font-bold text-2xl mb-1">李善龙</h4>
                <p className="text-amber-400 text-sm font-medium mb-6">总经理 · General Manager</p>
                <div className="space-y-2 w-full">
                  <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-gray-800/60 text-xs text-gray-300">
            ...
            <div className="rounded-2xl bg-gray-900 border border-gray-800 p-8 flex flex-col justify-center">
              ...
              <div className="space-y-3 text-gray-300 leading-relaxed text-sm">
                <p>
                  <span className="text-amber-400 font-semibold">SINOCV</span> 总部位于香港，为全球客户提供从选型、定制、验车、物流到清关的全链条商用车出口服务。
                </p>
                <p>
                  合作品牌：<span className="text-white font-medium">中国重汽、徐工集团、中集车辆、福田汽车</span>，均为原厂正品。
                </p>
                <p>
                  产品覆盖牵引车、自卸车、搅拌车、专用车、挖掘机、装载机、矿卡、挂车、Van等。
                </p>
                <p>
                  已出口至非洲、中东、东南亚、中亚等 30+ 国家和地区。
                </p>
              </div>
              <div className="mt-4 pt-4 border-t border-gray-800/50">
                <p className="text-gray-400 italic text-sm">
                  🎯 <span className="text-amber-400 font-medium">宗旨：</span>
                  以客户需求为导向，以品质服务为根本。
                </p>
              </div>
            </div>
