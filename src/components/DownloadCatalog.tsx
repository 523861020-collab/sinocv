...
const catalogs = [
  ...
  },
  {
    ...
    file: 'https://wa.me/8619103781257',
    size: '213 MB',
    icon: '🚛'
  }
];
  ...
  return (
    <section id="catalog" className="bg-black py-24">
      <div className="px-6 lg:px-16 max-w-[1920px] mx-auto">
        ...
        >
          <p className="mb-4 text-blue-500 tracking-widest text-sm">DOWNLOAD</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {catalogs.map((cat, index) => (
            <motion.a
              ...
              className="group rounded-xl bg-gray-900 border border-gray-800 p-8 transition-all hover:border-blue-500/50 hover:bg-gray-900/80"
            >
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="flex items-center gap-2 text-blue-500 font-semibold group-hover:gap-3 transition-all">
                  下载
